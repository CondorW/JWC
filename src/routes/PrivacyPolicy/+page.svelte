...
<div class="">
	...
	<ul>
		...
		<li>
			<p>
				...
				or &quot;Our&quot; in this Agreement) refers to DataEstateAustria, Grünentorgasse 12/5, 1010
				Wien.
			</p>
		</li>
		<li>
		...
		<li>
			<p>
				<strong>Website</strong> refers to Data Estate Austria, accessible from
				<a href="www.dataestate.at" rel="external nofollow noopener" target="_blank"
					>www.dataestate.at</a
				>
			</p>
		</li>
	...
	<p>
		Our Service does not address anyone under the age of 14. We do not knowingly collect personally
		identifiable information from anyone under the age of 14. If You are a parent or guardian and
		You are aware that Your child has provided Us with Personal Data, please contact Us. If We
		become aware that We have collected Personal Data from anyone under the age of 14 without
	...
	<ul>
		<li>By email: dataestateaustria@gmail.com</li>
	</ul>
</div>
...
<h1>Datenverarbeitung</h1>
	<p><strong>Name der Datenverarbeitung:</strong> DataEstate</p>
php
Copy code
<h2>Rechtsgrundlage Einwilligung</h2>
...
<!-- bitte Zwecke der Datenverarbeitung ergänzen, z.B. Information über unsere Produkte -->
<p>Sie können diese Einwilligung jederzeit widerrufen. Ein Widerruf hat zur Folge, dass wir Ihre Daten ab diesem Zeitpunkt zu oben genannten Zwecken nicht mehr verarbeiten. Für einen Widerruf wenden Sie sich bitte an: <!--bitte hier die entsprechenden Kontaktdaten ergänzen--></p>

<h2>Rechtsgrundlage berechtigte Interessen</h2>
<p>Wir verarbeiten Daten über Sie aufgrund unserer berechtigten Interessen oder denen eines Dritten.</p>
<!-- bitte Begründung ergänzen, einschließlich Zweck der Datenverarbeitung sowie ob die Zurverfügungstellung verpflichtend ist und allenfalls welche Konsequenzen die Nichtbereitstellung hätte -->

<h2>Speicherdauer/Löschungsfrist</h2>
<p>Wir speichern Ihre Daten <!--bitte Frist bzw die Kriterien für die Löschung pro Datenkategorie ergänzen, aus denen sich auch der Zweck der Speicherung ergeben muss. Bei Vorhandensein können auch die gesetzlichen Bestimmungen zitiert werden, siehe dazu das Merkblatt „Speicher- und Aufbewahrungsfristen"--></p>

<h2>Auftragsverarbeiter</h2>
<p>Für diese Datenverarbeitung ziehen wir Auftragsverarbeiter heran.</p>
<!-- bitte pro Auftragsverarbeiter/Auftragsverarbeiterkategorie die übermittelten Datenkategorien und den Gegenstand des Auftrags anführen; bei entsprechender Komplexität bietet sich eine tabellarische Darstellung an -->

<p>Ihre Daten werden zumindest zum Teil auch außerhalb der EU bzw. des EWR verarbeitet, und zwar in:</p>
<!-- bitte Staat(en) ergänzen -->
<p>Es liegt einer der Ausnahmefälle nach Art 49 Abs 1 DSGVO vor. Das sind unter anderem:</p>
<ul>
	<li>Einwilligung</li>
	<li>Vertragserfüllung</li>
	<li>Geltendmachung, Ausübung oder Verteidigung von Rechtsansprüchen</li>
	<li>Lebenswichtige Interesse der betroffenen Person</li>
</ul>

<h2>Kontakt</h2>
<p>Sie erreichen uns unter folgenden Kontaktdaten: <!--bitte Ihren Unternehmensnamen und Ihre Kontaktdaten ergänzen--></p>

<h2>Rechtsbehelfsbelehrung</h2>
<p>Da wir die Daten in unseren berechtigten Interessen verarbeiten, haben Sie grundsätzlich ein Widerspruchsrecht</p>