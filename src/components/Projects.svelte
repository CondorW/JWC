<section class="mb-32 text-gray-800 text-center lg:text-left">
    <h2 class="text-3xl font-bold mb-12 text-center text-neutral-content">Projects we are proud of</h2>
    ...
    <div class="grid lg:grid-cols-3 gap-x-6">
      <div class="mb-12 lg:mb-0">
        ...
        <h5 class="text-lg font-bold mb-3 text-neutral-content">Hollywood Exhibition</h5>
      ...
      <div class="mb-12 lg:mb-0">
        ...
        <h5 class="text-lg font-bold mb-3 text-neutral-content">Big Apple</h5>
      ...
      <div class="mb-0">
        ...
        <h5 class="text-lg font-bold mb-3 text-neutral-content">Sun City</h5>
