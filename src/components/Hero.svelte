...
<div>
	<div style="clip-path: polygon(0 0, 100% 0, 100% 90%, 0 calc(100% - 10vw));">
		<!-- This makes the sledged edge  -->
		<div
			class="hero min-h-screen"
			style="background-image: url(https://api.lorem.space/image/car?w=1080&h=1920)"
		>
