<section class="mb-32 text-gray-800 text-center">
    <div class="flex justify-center">
      <div class="text-center max-w-[700px]">
        <h2 class="text-3xl font-bold mb-6 text-center text-neutral-content">
          Why is it so great?
        </h2>
        <p class="text-base-content mb-12">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-4 lg:gap-x-12">
      <div class="mb-12 lg:mb-0">
        <div class="p-4 bg-secondary rounded-full shadow-lg inline-block mb-6">
        ...
        <h5 class="text-lg font-bold mb-4 text-neutral-content">Support 24/7</h5>
      ...
      <div class="mb-12 lg:mb-0">
        <div class="p-4 bg-error rounded-full shadow-lg inline-block mb-6">
          <svg class="w-5 h-5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="currentColor"
        ...
        <h5 class="text-lg font-bold mb-4 text-neutral-content">Safe and solid</h5>
        <p class="text-base-content">
      ...
      <div class="mb-12 md:mb-0">
        <div class="p-4 bg-accent rounded-full shadow-lg inline-block mb-6">
        ...
        <h5 class="text-lg font-bold mb-4 text-neutral-content">Extremely fast</h5>
        <p class="text-base-content">
      ...
      <div class="mb-12 md:mb-0">
        ...
        <h5 class="text-lg font-bold mb-4 text-neutral-content">Live analytics</h5>
        <p class="text-base-content">
